<?php
    ...
    $sql = "SELECT  L.IdLicencia, C.Nombre, C.FechaNacimiento, L.FechaExpedicion, C.Foto , C.Direccion, C.Donador
	FROM Licencias L, Conductores C 
    WHERE L.IdConductor = C.IdConductores
    AND L.IdLicencia = ".$_REQUEST['idlicencia'];
    // echo "This is the IDLicencia ". $_REQUEST['idlicencia'];
    ...
    // imágenes
    $escudo = "pdf/escudo.jpeg";
    $foto = "pdf/pp.png";
    // $foto = "'pdf/".$fila[4]."'";
    $firma = 'pdf/firma.png';
	$qro = 'pdf/FEstado.png';
	$Emer = 'pdf/066.png';
	$Denuncia = 'pdf/089.png';
	$firma2 = 'pdf/firma2.png';
	$leyen = 'pdf/leyenda.jpg';
	$Secre = 'pdf/secre.jpg';
	// $pdf->Addpage();
	$pdf->SetFont('Arial','','8');
	...
	$pdf->SetFont('Arial','','8');
	$pdf->SetXY(50, 30);
	$pdf->MultiCell(45,5,$fila[5],0,'R','0');
	$pdf->SetXY(60, 40);
	$pdf->SetFont('Arial','B','8');
