<?php
    ...
    $Con = conectar();
    $SQL = "DELETE FROM Vehiclos WHERE IdVehiculos='$Vehiculo'";
    consultar($Con, $SQL);
    // cerrar($Con);
    
    if(mysqli_affected_rows($Con) >= 1) {
        print("Vehiculo <b>".$Vehiculo."</b> eliminada correctamente<br>");
        ...
        echo("<h2>El Vehiculo no existe en la Base de Datos</h2>");
